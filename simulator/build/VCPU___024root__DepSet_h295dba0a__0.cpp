...
VL_INLINE_OPT void VCPU___024root___nba_sequent__TOP__0(VCPU___024root* vlSelf) {
    ...
    if (vlSelf->rstn) {
        ...
        if (((0x300U == (IData)(vlSelf->CPU__DOT__csr_waddr_wb)) 
        ...
        if (((0x341U == (IData)(vlSelf->CPU__DOT__csr_waddr_wb)) 
             & (IData)(vlSelf->CPU__DOT__csr_we_wb))) {
            vlSelf->CPU__DOT__CSR_inst__DOT__mepc = vlSelf->CPU__DOT__csr_wdata_wb;
        }
        ...
        vlSelf->CPU__DOT__CSR_inst__DOT__mstatus = 0U;
    ...
    vlSelf->CPU__DOT__csr_waddr_ls = ((IData)(vlSelf->rstn)
                                       ? (IData)(vlSelf->CPU__DOT__csr_waddr_ex)
                                       : 0U);
    vlSelf->CPU__DOT__csr_waddr_ex = ((1U & ((~ (IData)(vlSelf->rstn)) 
                                             | (IData)(vlSelf->CPU__DOT__ID_EX_flush)))
                                       ? 0U : (vlSelf->CPU__DOT__inst_id 
                                               >> 0x14U));
    vlSelf->CPU__DOT__csr_wdata_ls = ((IData)(vlSelf->rstn)
                                       ? ((4U & (IData)(vlSelf->CPU__DOT__csr_op_ex))
    ...
    if (vlSelf->rstn) {
        ...
        vlSelf->CPU__DOT__csr_we_ls = vlSelf->CPU__DOT__csr_we_ex;
    } else {
        vlSelf->CPU__DOT__PC_inst__DOT__pc_reg = 0x80000000U;
        vlSelf->CPU__DOT__csr_we_ls = 0U;
    }
    ...
    vlSelf->CPU__DOT__pc_set = ((IData)(vlSelf->CPU__DOT__csr_we_ex) 
...
#endif
                    VL_FATAL_MT("/home/xhyvm2/gitwork/labs/COMPSYS/simulator/IP/mycpu/CPU.sv", 2, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/xhyvm2/gitwork/labs/COMPSYS/simulator/IP/mycpu/CPU.sv", 2, "", "NBA region did not converge.");
            }
