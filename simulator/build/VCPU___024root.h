...
class alignas(VL_CACHE_LINE_BYTES) VCPU___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ CPU__DOT__ICache_inst__DOT____VdfgTmp_h32c1d4e2__0;
        ...
        CData/*0:0*/ CPU__DOT__DCache_inst__DOT__uncache;
